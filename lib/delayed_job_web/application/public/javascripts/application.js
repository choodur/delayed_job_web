$(function() {
  ...
  $('a.handler_details').click(function (e) {
    e.preventDefault();
    if($(this).prev('div.handler_details:visible').length > 0) {
      $(this).next('div.handler_details').show();
      $(this).prev('div.handler_details').hide();
    } else {
      $(this).next('div.handler_details').hide();
      $(this).prev('div.handler_details').show();
    }
  });
});